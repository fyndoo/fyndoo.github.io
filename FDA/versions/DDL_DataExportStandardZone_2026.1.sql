...
CREATE TABLE sz_facilityreference (
	...
	CONSTRAINT "PK_sz_facilityreference" PRIMARY KEY (facilityreferenceid)
);
...
-- sz_workflowprocessdefinition definition

-- Drop table

-- DROP TABLE sz_workflowprocessdefinition;

CREATE TABLE sz_workflowprocessdefinition (
	referenceid varchar(128) NOT NULL,
	whitelabel varchar(255) NULL,
	processname varchar(255) NULL,
	processtype varchar(255) NULL,
	beginstatus varchar(255) NULL,
	CONSTRAINT "PK_workflowprocessdefinition_refid" PRIMARY KEY (referenceid)
);


-- sz_workflowstatusdefinition definition

-- Drop table

-- DROP TABLE sz_workflowstatusdefinition;

CREATE TABLE sz_workflowstatusdefinition (
	referenceid varchar(128) NOT NULL,
	workflowprocessreferenceid varchar(128) NOT NULL,
	statuscode varchar(255) NULL,
	statusname varchar(255) NULL,
	statusgroupname varchar(255) NULL,
	endstatus bool NULL,
	isprocessreadyforfilling bool NULL,
	isterminationsuccessful bool NULL,
	CONSTRAINT "PK_statusdefinition_refid" PRIMARY KEY (referenceid)
);
...
-- sz_calcmodel_customerbased definition

-- Drop table

-- DROP TABLE sz_calcmodel_customerbased;

CREATE TABLE sz_calcmodel_customerbased (
	documentid varchar(128) NOT NULL,
	financialsid varchar(128) NOT NULL,
	documenttype varchar(128) NULL,
	CONSTRAINT "PK_sz_calcmodel_customerbased" PRIMARY KEY (documentid),
	CONSTRAINT "FK_calcmodel_customerbased_financials" FOREIGN KEY (financialsid) REFERENCES sz_financials(financialsid) ON DELETE CASCADE
);


-- sz_calcmodel_customerbaseddetails definition

-- Drop table

-- DROP TABLE sz_calcmodel_customerbaseddetails;

CREATE TABLE sz_calcmodel_customerbaseddetails (
	documentid varchar(128) NULL,
	columnenddate date NULL,
	variablename varchar(128) NULL,
	stringvalue varchar(255) NULL,
	numericvalue float8 NULL,
	t1 int8 NULL,
	t2 int8 NULL,
	t3 int8 NULL,
	CONSTRAINT "UK_sz_calcmodel_customerbaseddetails" UNIQUE (documentid, columnenddate, variablename, t1, t2, t3),
	CONSTRAINT "FK_calcmodel_customerbaseddetails" FOREIGN KEY (documentid) REFERENCES sz_calcmodel_customerbased(documentid) ON DELETE CASCADE
);
...
-- sz_funder definition

-- Drop table

-- DROP TABLE sz_funder;

CREATE TABLE sz_funder (
	referenceid varchar(128) NOT NULL,
	fundertype varchar(20) NOT NULL,
	tenantformattedreferenceid varchar(128) NULL,
	fundername varchar(255) NULL,
	cocnumber varchar(20) NULL,
	birthdate date NULL,
	socialsecuritynumber varchar(255) NULL,
	CONSTRAINT "PK_sz_funder" PRIMARY KEY (referenceid)
);


-- sz_fundingaccount definition

-- Drop table

-- DROP TABLE sz_fundingaccount;

CREATE TABLE sz_fundingaccount (
	referenceid varchar(128) NOT NULL,
...
CREATE TABLE sz_fundingaccount_periodicstatement (
	fundingaccountreferenceid varchar(128) NOT NULL,
	reportreference varchar(255) NOT NULL,
	reportcreationdate timestamp NULL,
...
-- DROP TABLE sz_financialstate;

CREATE TABLE sz_financialstate (
	facilityreferenceid varchar(128) NOT NULL,
	timestampfinancialstate timestamp NULL,
	currentoutstanding numeric(19, 2) NULL,
	arrearsamount numeric(19, 2) NULL,
	arrearcode numeric(1) NULL,
	isactive bool NULL,
	overduepaymentobligationamount numeric(19, 2) NULL,
	outstandingamountafterscheduledtransactions numeric(19, 2) NULL,
	installmentamount numeric(19, 2) NULL,
	surplusamount numeric(19, 2) NULL,
	initialamount numeric(19, 2) NULL,
	nextinstallmentinterestamount numeric(19, 2) NULL,
	nextinstallmentpayoffamount numeric(19, 2) NULL,
	brokenperiodinterestamount numeric(19, 2) NULL,
	outstandingpayoff numeric(19, 2) NULL,
...
-- DROP TABLE sz_financialstate_agreementlevel;

CREATE TABLE sz_financialstate_agreementlevel (
...
-- sz_periodicstatement_agreementlevel definition

-- Drop table

-- DROP TABLE sz_periodicstatement_agreementlevel;

CREATE TABLE sz_periodicstatement_agreementlevel (
	agreementreferenceid varchar(128) NOT NULL,
	reportreference varchar(255) NOT NULL,
	reportcreationdate timestamp NULL,
	periodtype varchar(255) NOT NULL,
...
CREATE TABLE sz_process (
	...
	durationtimehours numeric(19, 2) NULL,
	...
	currentstatusgroupname varchar(255) NULL,
...
CREATE TABLE sz_processevents (
	...
	conditionalofferdate_hours numeric(19, 2) NULL,
	bindingofferdate timestamp NULL,
	bindingofferdate_hours numeric(19, 2) NULL,
	processedfinancialfiguresauto bool NULL,
	offersent bool NULL,
	finishedsuccessful bool NULL,
	finishedsuccessfuldate timestamp NULL,
	readyforfiling bool NULL,
	readyforfilingdate timestamp NULL,
...
CREATE TABLE sz_processstatuschange (
	...
	fromreferenceid varchar(128) NULL,
	toreferenceid varchar(128) NULL,
...
CREATE TABLE sz_sli (
	...
	CONSTRAINT "FK_sli_financials" FOREIGN KEY (financialsid) REFERENCES sz_financials(financialsid) ON DELETE CASCADE,
	CONSTRAINT "FK_sli_process" FOREIGN KEY (processnumber) REFERENCES sz_process(processnumber)
);
...
-- sz_statuschangedefinition definition

-- Drop table

-- DROP TABLE sz_statuschangedefinition;

CREATE TABLE sz_statuschangedefinition (
	workflowprocessreferenceid varchar(128) NOT NULL,
	fromreferenceid varchar(255) NOT NULL,
	toreferenceid varchar(255) NOT NULL,
	tostatuscode varchar(255) NULL,
	tostatusname varchar(255) NULL,
	statusgroupname varchar(255) NULL,
	automaticstatuschange bool NULL,
	CONSTRAINT "PK_sz_statuschangedefinition" PRIMARY KEY (fromreferenceid, toreferenceid),
	CONSTRAINT "FK_statuschangefromreferenceid" FOREIGN KEY (fromreferenceid) REFERENCES sz_workflowstatusdefinition(referenceid) ON DELETE CASCADE,
	CONSTRAINT "FK_statuschangetoreferenceid" FOREIGN KEY (toreferenceid) REFERENCES sz_workflowstatusdefinition(referenceid) ON DELETE CASCADE,
	CONSTRAINT "FK_workflowprocessreferenceid" FOREIGN KEY (workflowprocessreferenceid) REFERENCES sz_workflowprocessdefinition(referenceid) ON DELETE CASCADE
);
...
-- sz_calcmodel_processbased definition

-- Drop table

-- DROP TABLE sz_calcmodel_processbased;

CREATE TABLE sz_calcmodel_processbased (
	documentid varchar(128) NOT NULL,
	financialsid varchar(128) NOT NULL,
	processnumber int8 NOT NULL,
	documenttype varchar(128) NULL,
	CONSTRAINT "PK_sz_calcmodel_processbased" PRIMARY KEY (documentid),
	CONSTRAINT "FK_calcmodel_processbased_financials" FOREIGN KEY (financialsid) REFERENCES sz_financials(financialsid) ON DELETE CASCADE,
	CONSTRAINT "FK_calcmodel_processbased_proces" FOREIGN KEY (processnumber) REFERENCES sz_process(processnumber)
);


-- sz_calcmodel_processbaseddetails definition

-- Drop table

-- DROP TABLE sz_calcmodel_processbaseddetails;

CREATE TABLE sz_calcmodel_processbaseddetails (
	documentid varchar(128) NOT NULL,
	columnenddate date NULL,
	variablename varchar(128) NULL,
	stringvalue varchar(255) NULL,
	...
	t2 int8 NULL,
	t3 int8 NULL,
	CONSTRAINT "PK_sz_calcmodel_processbaseddetails" UNIQUE (documentid, columnenddate, variablename, t1, t2, t3),
	CONSTRAINT "FK_calcmodel_processbaseddetails" FOREIGN KEY (documentid) REFERENCES sz_calcmodel_processbased(documentid) ON DELETE CASCADE
);
...
CREATE TABLE sz_counterparty (
	...
	housenumberaddition varchar(255) NULL,
	postalcode varchar(10) NULL,
	city varchar(255) NULL,
	countryofaddress varchar(255) NULL,
	countrycodeofaddress varchar(25) NULL,
	isholding bool NULL,
	...
	islatestapprovedversion bool NULL,
	preferredname varchar(55) NULL,
	dateofbankruptcy date NULL,
...
-- sz_counterparty_fiscal_info definition

-- Drop table

-- DROP TABLE sz_counterparty_fiscal_info;

CREATE TABLE sz_counterparty_fiscal_info (
	counterpartyreferenceid varchar(128) NOT NULL,
	processnumber int8 NOT NULL,
	birthdate date NULL,
	socialsecuritynumber varchar(255) NULL,
	CONSTRAINT "PK_sz_counterparty_fiscal_info" PRIMARY KEY (counterpartyreferenceid, processnumber),
	CONSTRAINT "FK_sz_counterparty_fiscal_info" FOREIGN KEY (counterpartyreferenceid,processnumber) REFERENCES sz_counterparty(referenceid,processnumber) ON DELETE CASCADE
);
...
CREATE TABLE sz_otherproperties (
	processnumber int8 NOT NULL,
	additionalrentalincome numeric(19, 2) NULL,
...
-- sz_agreement_periodicstatement definition

-- Drop table

-- DROP TABLE sz_agreement_periodicstatement;

CREATE TABLE sz_agreement_periodicstatement (
	agreementreferenceid varchar(128) NOT NULL,
	mainborrowerreferenceid varchar(128) NULL,
	processnumber_last_successful int8 NOT NULL,
	CONSTRAINT "PK_agreementreferenceid" PRIMARY KEY (agreementreferenceid),
	CONSTRAINT "FK_agreementreferenceid" FOREIGN KEY (agreementreferenceid,processnumber_last_successful) REFERENCES sz_agreement(referenceid,processnumber)
);
...
CREATE TABLE sz_collateral (
	...
	valuationamount numeric(19, 2) NULL,
	externalreferenceid varchar(128) NULL,
	amortizationfrequency varchar(128) NULL,
	firstreductiondatestrategy varchar(128) NULL,
	amortizationtype varchar(128) NULL,
	numberofperiods int4 NULL,
	firstreductiondate date NULL,
...
CREATE TABLE sz_collateral_object (
	...
	marketvalue numeric(19, 2) NULL,
	purchasevalue numeric(19, 2) NULL,
	executionvalue numeric(19, 2) NULL,
	energylabel varchar(25) NULL,
	energylabelafterrenovation varchar(25) NULL,
	externalreferenceid varchar(128) NULL,
	...
	propertysurface numeric(19, 2) NULL,
	officespacesurface numeric(19, 2) NULL,
	street varchar(255) NULL,
	country varchar(255) NULL,
	"rank" int4 NULL,
	prioramount numeric(19, 2) NULL,
	colllateraltype varchar(255) NULL,
	colllateraltypecode varchar(255) NULL,
...
-- sz_collateral_object_monumentregistration definition

-- Drop table

-- DROP TABLE sz_collateral_object_monumentregistration;
...
CREATE TABLE sz_collateral_object_rental (
	...
	admissiblemonthlyrent numeric(19, 2) NULL,
	coldrentpermonth numeric(19, 2) NULL,
	marketbasedrent numeric(19, 2) NULL,
	totalrentpermonth numeric(19, 2) NULL,
	totalrentperyear numeric(19, 2) NULL,
	agreementreferenceid varchar(128) NULL,
...
CREATE TABLE sz_collateral_object_taxation (
	...
	valuationvalue numeric(19, 2) NULL,
	marketvaluecurrentstate numeric(19, 2) NULL,
...
CREATE TABLE sz_facility (
	...
	agreedlimitamount numeric(19, 2) NULL,
	agreedlimitcurrency varchar(10) NULL,
	limitamount numeric(19, 2) NULL,
	...
	blockingamount numeric(19, 2) NULL,
	blockingamountmotivation varchar(255) NULL,
...
-- sz_facility_periodicstatement definition

-- Drop table

-- DROP TABLE sz_facility_periodicstatement;

CREATE TABLE sz_facility_periodicstatement (
	facilityreferenceid varchar(128) NOT NULL,
	agreementreferenceid varchar(128) NOT NULL,
	processnumber_last_successful int8 NOT NULL,
	CONSTRAINT "PK_facilityreferenceid" PRIMARY KEY (facilityreferenceid),
	CONSTRAINT "FK_sz_facility_periodicstatement" FOREIGN KEY (facilityreferenceid,processnumber_last_successful) REFERENCES sz_facility(referenceid,processnumber)
);
