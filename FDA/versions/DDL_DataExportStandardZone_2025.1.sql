...
CREATE TABLE sz_calcmodel_customerbaseddetails (
	...
	t2 int8 NULL,
	t3 int8 NULL,
	CONSTRAINT "PK_sz_calcmodel_customerbaseddetails" UNIQUE (documentid, columnenddate, variablename, t1, t2, t3),
...
CREATE TABLE sz_financialstate (
	...
	CONSTRAINT "FK_sz_facilityreference_fs" FOREIGN KEY (facilityreferenceid) REFERENCES sz_facilityreference(facilityreferenceid) ON DELETE CASCADE
);
...
CREATE TABLE sz_periodicstatement (
	...
	CONSTRAINT "FK_sz_facilityreference_ps" FOREIGN KEY (facilityreferenceid) REFERENCES sz_facilityreference(facilityreferenceid) ON DELETE CASCADE
);
...
CREATE TABLE sz_statuschangedefinition (
	referenceid varchar(128) NOT NULL,
	workflowprocessreferenceid varchar(128) NOT NULL,
	fromreferenceid varchar(255) NULL,
	toreferenceid varchar(255) NULL,
	tostatuscode varchar(255) NULL,
	tostatusname varchar(255) NULL,
	statusgroupname varchar(255) NULL,
	automaticstatuschange bool NULL,
	CONSTRAINT "PK_statuschangedefinition_refid" PRIMARY KEY (referenceid),
...
CREATE TABLE sz_facility (
	...
	CONSTRAINT "FK_sz_facilityreference" FOREIGN KEY (referenceid) REFERENCES sz_facilityreference(facilityreferenceid) ON DELETE CASCADE
);
