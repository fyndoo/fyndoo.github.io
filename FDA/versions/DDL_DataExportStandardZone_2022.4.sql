...
-- sz_portalrequest definition

-- Drop table

-- DROP TABLE sz_portalrequest;

CREATE TABLE sz_portalrequest (
	referenceid varchar(255) NULL,
	"entrepreneurUserId" varchar(255) NULL,
	"entrepreneurUserLastName" varchar(255) NULL,
	"entrepreneurUserEmailAddress" varchar(255) NULL,
	creationdate timestamp NULL,
	modificationdate timestamp NULL,
	sentdate timestamp NULL,
	"externalReferenceId" varchar(255) NULL,
	"requestedLoanAmount" numeric(11, 2) NULL,
	"financingGoalCode" int8 NULL,
	"financingGoalName" varchar(255) NULL,
	"repaymentTypeCode" int8 NULL,
	"repaymentTypeName" varchar(255) NULL,
	"entrepreneurIsPrivatePerson" bool NULL,
	"entrepreneurEmailAddress" varchar(255) NULL,
	"contactInfoLastName" varchar(255) NULL,
	"contactInfoMobileNumber" varchar(255) NULL,
	"contactInfoEmailAddress" varchar(255) NULL,
	"contactInfoOrganisationName" varchar(255) NULL
);
...
CREATE TABLE sz_annualaccountsdetails (
	annualaccountsid varchar(128) NOT NULL,
	columnenddate date NOT NULL DEFAULT now(),
...
CREATE TABLE sz_businessrules (
	referenceid varchar(16) NOT NULL,
	processnumber int8 NOT NULL,
...
CREATE TABLE sz_businessrules_parameters (
	referenceid varchar(16) NOT NULL,
	businessrulereferenceid varchar(16) NOT NULL,
	processnumber int8 NOT NULL,
	fiatreferenceid varchar(255) NOT NULL,
...
CREATE TABLE sz_facility (
	...
	interestreferencedate timestamp NULL,
	interestproductstartdate timestamp NULL,
	firstinterestpaymentdate timestamp NULL,
	interestproductenddate timestamp NULL,
	firstrepaymentdate timestamp NULL,
