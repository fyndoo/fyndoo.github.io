...
CREATE TABLE sz_processstatuschange (
	...
	statuschangereferenceid varchar(128) NULL,
	...
	CONSTRAINT "FK_statuschangedefinition" FOREIGN KEY (statuschangereferenceid) REFERENCES sz_statuschangedefinition(referenceid) ON DELETE CASCADE
);
